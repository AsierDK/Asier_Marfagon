<?php
    ...
    function listarEmpleado($dept)
    {
        $conn = conexionBBDD();
        try 
        {
            $stmt = $conn->prepare("SELECT DISTINCT(nombre) nombre from emple e,emple_dpto ed where cod_dpto= :dpto and ed.dni= e.dni and fecha_fin is NULL");
